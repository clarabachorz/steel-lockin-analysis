...
df_plot_production <- df_production_regions %>%
  ...
  #                                           "India","China", 
  #                                           "USA, Europe, Russia,\nJapan and ex-USSR countries"))) %>%
  mutate(Region = factor(Region, levels = c("USA, Europe, Russia,\nJapan and ex-USSR countries",
                                            "China","India",
                                            "Other Asia and Latin America",
                                            "Sub-saharan Africa"
                                            ))) %>%
...
p <- ggplot(data = df_plot_production,
  ...
  geom_rect(aes(xmin = start_year, xmax = 2022, ymin = 0, ymax = Inf), fill = "#d8d8d26e", alpha = 0.15) +
  geom_area() +
...
p <- p +  
  ...
  annotate("point", x = 1971, y = 1190, shape = 21, size = 5, fill = "white", color = col_ind) +
  ...
  annotate("text", x = 1971, y = 1185, label = "3", color = col_ind, size = 3) +
