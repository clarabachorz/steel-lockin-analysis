...
#riken gdx
early_trans <- "REMIND_EarlyTransition.gdx"
base <- "REMIND_StatusQuo.gdx"
prolonged_lockin <- "REMIND_ProlongedLockIn.gdx"
max_lockin <- "REMIND_ExtendedFossilDependence.gdx"
...
# gdx <- "./650_govtargets.gdx"
gdx <- max_lockin
#name for plotting
#name <- "Prolonged lifetime scenario"
