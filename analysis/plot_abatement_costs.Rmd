...
scenarios_for_lcop <- list(scenario0, scenario1, scenario2, scenario3)
...
Plot Figure 3b., which shows the total additional cost of the Fast Transition scenario compared to
...
```{R plot abatement costs vs CO2 value}

df <- run_scenario_cost_andCO2value_comparison(scenario1, scenario2, region_to_aggr, start_date, end_date, discount_rate = discount_rate)
p_scenariocost_vs_co2value <- df$plot
```
## Plot emission cascade plots
Plot Figure 3: combine the cumulated emission cascade plot with the scenario costs vs CO2 value plot.
...
## plot cascade plots: cumulative emissions (combined with abatement costs and co2 value plot)
