...
* We map the 12 regions onto 6 regions: China, India, OECD, Russia, Lat. America & Oth. Asia, and Middle East & Africa
...
df_plot <- (
    ...
    filter(period %in% c(2030, 2040, 2050))
)
show_sample(df_plot)
```
